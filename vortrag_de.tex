...
\begin{frame}
\frametitle{Beschleuniger: DESY2}
\vspace*{-2\baselineskip}
\begin{tikzpicture}[every node/.style={anchor=south east,inner sep=0pt}, x=0mm, y=0mm]   
    ...
    \only<2>{\node at (0, 0) {\includegraphics[width=\textwidth]{images/foto_desy_1965_resized.jpg}};}
...
\scalebox{0.65}{
    \begin{minipage}{17cm}
        ...
        \end{math}
        \\[2ex]
        Extrahiert von Thomas\,D.\,Gutierrez aus Diagrammatica von Martinus Veltman irgendwann 1999. \cite{stml} \\
    \end{minipage}
}
\end{frame}
...
\begin{tikzpicture}[every node/.style={anchor=south east,inner sep=0pt}, x=0mm, y=0mm]   
    ...
    \node [inner sep=3pt, rounded corners=3pt, draw, fill=white] at (-3mm,3mm) {
        \scalebox{0.5}{\parbox{9cm}{%
            ...
            maximale Brillianz: $1\times10^{\tiny 21}\,Photons\,/\,(s\,mm^2\,mrad^2\,0.1\,\%\,BW)$
    }}};
\end{tikzpicture}
\vspace*{-4pt}
\end{frame}
...
\begin{tikzpicture}[every node/.style={anchor=south east,inner sep=0pt}, x=0mm, y=0mm]   
    ...
    \node [inner sep=3pt, rounded corners=3pt, draw, fill=white] at (-3mm, 3mm) {
        \scalebox{0.5}{\parbox{9cm}{
            ...
            maximale Brillianz: $1\times10^{\tiny 31}\,Photons\,/\,(s\,mm^2\,mrad^2\,0.1\,\%\,BW)$
    }}};
\end{tikzpicture}
\vspace*{-22pt}
\end{frame}
...
\begin{tikzpicture}[every node/.style={anchor=south east,inner sep=0pt}, x=0mm, y=0mm]   
    ...
    \node [inner sep=3pt, rounded corners=3pt, draw, fill=white] at (-3mm, 3mm) {
        \scalebox{0.5}{\parbox{9cm}{
            ...
            Pulsdauer: <100\,fs \\
            maximale Brillianz: $5\times10^{\tiny 33}\,Photons\,/\,(s\,mm^2\,mrad^2\,0.1\,\%\,BW)$
            \end{minipage}
    }}};
\end{tikzpicture}
\end{frame}
...
\cite{DESYMediabank:2019-07-25_RS-0531_b1.jpg}
\end{frame}
