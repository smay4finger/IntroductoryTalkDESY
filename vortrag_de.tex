...
\vspace*{-2\baselineskip}
\begin{tikzpicture}[every node/.style={anchor=south west,inner sep=0pt}, x=0mm, y=0mm]   
     \node (photo) at (0,0){\includegraphics[width=\textwidth]{2019-07-25_RS-05261.jpg}};

     \node (overlay) at (0, 0){\includegraphics[width=\textwidth]{images/2019-07-25_RS-05261_overlay_petra.pdf}};
\end{tikzpicture}
\end{frame}
...
\vspace*{-2\baselineskip}
\begin{tikzpicture}
    \node[inner sep=0pt] at (0,0) {\includegraphics[width=0.9\textwidth]{beschleuniger-desy}};
